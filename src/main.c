...
int main() {
    ...
    while(!WindowShouldClose()) {
        ...
        int grid_size = tile.pixels * tile.pixels_size;
        Vector2 mouse_cell = { 0 };
        GuiGrid((Rectangle) { two_thirds_width/2 - grid_size/2 , screen_height/2 - grid_size/2,  grid_size, grid_size }, "", tile.pixels_size, 1, &mouse_cell);
